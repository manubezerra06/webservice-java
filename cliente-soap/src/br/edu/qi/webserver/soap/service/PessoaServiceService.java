 ...
 * 
 */
@WebServiceClient(name = "PessoaServiceService", targetNamespace = "http://service.soap.webserver.qi.edu.br/", wsdlLocation = "http://localhost/8081/pessoaWs?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PESSOASERVICESERVICE_QNAME = new QName("http://service.soap.webserver.qi.edu.br/", "PessoaServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost/8081/pessoaWs?wsdl");
     ...
     * 
     * @return
     *     returns IPessoaService
     */
    @WebEndpoint(name = "PessoaServicePort")
    public IPessoaService getPessoaServicePort() {
        return super.getPort(new QName("http://service.soap.webserver.qi.edu.br/", "PessoaServicePort"), IPessoaService.class);
    }
     ...
     */
    @WebEndpoint(name = "PessoaServicePort")
    public IPessoaService getPessoaServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.soap.webserver.qi.edu.br/", "PessoaServicePort"), IPessoaService.class, features);
    }
